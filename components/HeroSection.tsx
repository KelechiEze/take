    ...
    <>
      ...
      <div ref={mobileMenuRef} className="fixed top-0 right-0 h-full w-full max-w-xs bg-black z-[101] shadow-lg p-8 transform translate-x-full md:hidden">
         ...
         <div className="flex flex-col gap-6 text-xl items-center">
            <a href="#" className="font-semibold hover:text-orange-400 transition-colors" onClick={() => setIsMenuOpen(false)}>Home</a>
            <a href="#" className="font-semibold hover:text-orange-400 transition-colors" onClick={() => setIsMenuOpen(false)}>Speakers</a>
            <a href="#" className="font-semibold hover:text-orange-400 transition-colors" onClick={() => setIsMenuOpen(false)}>Schedule</a>
            <a href="#" className="font-semibold hover:text-orange-400 transition-colors" onClick={() => setIsMenuOpen(false)}>Tickets</a>
