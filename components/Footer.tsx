        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-orange-500 transition-colors">Speakers</a></li>
              <li><a href="#" className="hover:text-orange-500 transition-colors">Schedule</a></li>
              <li><a href="#" className="hover:text-orange-500 transition-colors">Get Tickets</a></li>
            </ul>
          </div>
